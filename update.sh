wget -q https://raw.githubusercontent.com/Fitunnel/AutoScriptKYT/main/Fls/http -O /usr/bin/http
...
cek_versi_baru() {
versi_terbaru=$(curl -s https://raw.githubusercontent.com/Fitunnel/AutoScriptKYT/main/update-cek)
...
wget https://raw.githubusercontent.com/Fitunnel/AutoScriptKYT/main/Cdy/speedtest -O /usr/local/sbin/speedtest
wget https://raw.githubusercontent.com/Fitunnel/AutoScriptKYT/main/Cdy/menu.zip -O menu.zip >/dev/null 2>&1
rm -rf /usr/bin/menu /usr/bin/welcome
wget https://raw.githubusercontent.com/Fitunnel/AutoScriptKYT/main/enc
...
<code>◇━━━━━━━━━━━━━━◇</code>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/FiStoreVPN_GiveBot"},{"text":"Contact","url":"https://wa.me/6285223659782"}]]}'
